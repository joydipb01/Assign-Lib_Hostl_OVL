...
<nav class="navbar navbar-default">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="updateRoom.php">Update Room</a></li>
...
<form action="updateRoombts.php" method="post" align="center">
...
<input type="text" class="ggg" placeholder="Enter Floor Number" name="fno" id="fno" required><br>
