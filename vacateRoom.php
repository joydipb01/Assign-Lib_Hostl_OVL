...
<nav class="navbar navbar-default">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
			...
			<li class="active"><a href="vacateRoom.php">Vacate Room</a></li>
...
<div class="well">
	<h3>Vacate a Room</h3>
<form action="vacateRoombts.php" method="post" align="center">
...
<input type="text" class="ggg" placeholder="Enter Student ID" name="sid" id="sid" pattern="[0-9]{2}[A-Z]{4}[0-9]{2}" required><br>
 ...
 <button type="submit" name="action" value="vacate">Vacate</button><br>
</form> 
</div>
</div>
</body>
