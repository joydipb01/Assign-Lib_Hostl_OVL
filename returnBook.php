...
<div class="well">
	<h3>Return Book</h3>
<form action="returnBookbts.php" method="post" align="center">
<input type="hidden" name="action" value="add"> 
<label for= "Bookid">Book ID</label>
<input type="text" class="ggg" placeholder="Enter Book ID" name="bookid" id="bookid" pattern="[0-9]{1,}" required><br>
<label for= "sid">Student ID</label>
<input type="text" class="ggg" placeholder="Enter Student ID" name="sid" id="sid" pattern="[0-9]{2}[A-Z]{4}[0-9]{2}" required><br>
 <div class="clearfix"></div>
 <button type="submit" name="action" value="return">Return</button><br>
</form> 
</div>
</div>
</body>
