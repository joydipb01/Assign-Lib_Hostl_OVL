...
<form action="updateBookbts.php" method="post" align="center">
<input type="hidden" name="action" value="add"> 
<label for= "Bookid">Book ID</label>
<input type="text" class="ggg" placeholder="Enter Book ID" name="bookid" id="bookid" required><br>       
<label for= "title">Book Title</label>
<input type="text" class="ggg" placeholder="Enter title of the book" name="title" id="title"><br>
<label for= "author">Author</label>
<input type="text" class="ggg" placeholder="Enter name of first author" name="author" id="author"><br>
<label for= "quantity"><abbr title="Quantity">Qty</abbr></label>
<input type="text" class="ggg" placeholder="Enter the number of copies for the Book" name="quantity" id="quantity" pattern="[0-9]{1, }"><br>
