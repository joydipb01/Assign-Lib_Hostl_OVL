...
<nav class="navbar navbar-default">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            <li class="active"><a href="addRoom.php">Add Room</a></li>
...
<div class="well">
	<h3>Add a Room</h3>
<form action="addRoombts.php" method="post" align="center">
<input type="hidden" name="action" value="add"> 
<label for= "Roomid">Room Number</label>
<input type="text" class="ggg" placeholder="Enter Room No." name="roomid" id="roomid" pattern="[0-9]{1,}" required><br>       
<label for= "title">Floor Number</label>
<input type="text" class="ggg" placeholder="Enter Floor Number" name="fno" id="fno" pattern="[0-9]{1,}" required><br>
