...
<form action="searchAuthorbts.php" method="post" align="center">
<input type="hidden" name="action" value="view"> 
<label for= "sid"><abbr title="Complete or Partial Search">Author Name</abbr></label>
<input type="text" class="ggg" placeholder="Enter Author Name" name="auth" id="auth" required><br> 
