...
<nav class="navbar navbar-default">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            <li class="active"><a href="viewLesson.php">View Lessons</a></li>
	...
	if(mysqli_num_rows($query)>=1){
		while($row=mysqli_fetch_array($query)){
			echo "<tr>";
				...
				echo '<td style="border:1px solid rgba(89, 59, 124, 0.767);width:33%"><a href='.$row["LINK"].' target="_blank">Learn</a></td>';
                echo "</tr>";
		}
	}
?>
